...
version = "results/version-%d-" % args.version
np.save(version+"loss_his", loss_his)
np.save(version+"accuracy_his", accuracy_his)
...
plt.subplot(1, 2, 2)
plt.plot(accuracy_his, label="accuracy")
