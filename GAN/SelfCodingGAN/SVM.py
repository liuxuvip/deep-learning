...
class SVM:
    ...
    def train(self, x, label):
        ...
        joblib.dump(self.clf, "train_svm_model_%d%s.m" % (self.id, global_define.run_version))

    def test(self, x, label):
        self.clf = joblib.load("train_svm_model_%d%s.m" % (self.id, global_define.run_version))
